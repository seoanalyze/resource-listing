...
Nova.booting(function (Vue, router, store) {
    Vue.component('resource-listing', __webpack_require__(2));
});
...
var render = function() {
  ...
  return _c(
    "loading-card",
    { staticClass: "h-auto", attrs: { loading: _vm.loading } },
    [
      _c(
        "div",
        ...
        [
          _c(
            "h4",
            { staticClass: "text-center text-2xl text-80 font-light mb-3" },
